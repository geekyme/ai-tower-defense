...
export const WAVES=[
 ...
 {e:0,t:'Five pilots, zero production',g:[['pilot',8,1.1],['hallu',14,.65,2],['ctx',20,.24,7]]},
 {e:0,t:'Show me value in ninety days',g:[['review',1,1],['roi',12,1.0,4],['ctx',22,.24,2],['hallu',6,1.1,14]]},
 {e:1,t:'Half the company is on a personal account',g:[['shadow',17,.65],['ctx',30,.2,3],['hallu',12,.8,8]]},
 {e:1,t:'Everyone built their own agent',g:[['sprawl',9,1.5],['roi',22,.5,2],['ctx',26,.2,8]]},
 {e:1,t:'Compute is rationed, expectations are not',g:[['gpu',11,1.1],['token',18,.5,1],['hallu',18,.5,4],['ctx',22,.22,10]]},
 ...
 {e:2,t:'Middle management has notes',g:[['frozen',10,1.4],['aiwash',15,.7,1],['ctx',30,.18,6],['roi',20,.5,10]]},
 {e:2,t:'Legal found out',g:[['pii',20,.5],['residency',8,1.4,2],['drift',16,.6,4],['inject',10,1.0,9]]},
 {e:2,t:'Audit week',g:[['audit',1,1],['docreq',34,.38,3],['frozen',7,1.9,7],['pii',18,.55,13]]},
 {e:3,t:'Accuracy fell off a cliff quietly',g:[['drift',26,.45],['silent',17,.65,2],['evalgap',14,.8,4],['ctx',30,.18,11]]},
 ...
 {e:4,t:'Everything at once',g:[['frozen',8,1.8],['residency',8,1.4,1],['silent',12,.9,3],['inject',11,1.1,5],['mandate',8,1.5,13]]},
